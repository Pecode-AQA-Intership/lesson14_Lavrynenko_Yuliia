...
//checked invalin data

    // it('Check of invalid input', () => {
    //   //enter full name field 
    //   cy.get(data.selectorName)
    //     .type(data.INV_FULL_NAME)
    //     .should('have.value', '')
    
    //   // enter email
    //   cy.get(data.selectorEmail)
    //     .type(data.INV_EMAIL)
    //     .should('have.value', data.INV_EMAIL)
    
    //   //enter current address
    //   cy.get(data.selectorCurrentAddress)
    //     .type(data.INV_CURRENT_ADDRESS)
    //     .should('have.value', data.INV_CURRENT_ADDRESS)
    
    //   //enter permanent address
    //   cy.get(data.selectorPermanentAddress)
    //     .type(data.INV_PERMANENT_ADDRESS)
    //     .should('have.value', data.INV_PERMANENT_ADDRESS)
    //   // clicked submit button
    //   cy.get('#submit').click();
